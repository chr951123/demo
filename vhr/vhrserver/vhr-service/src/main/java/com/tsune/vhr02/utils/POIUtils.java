...
public class POIUtils {
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //文档管理员
        docInfo.setManager("Tsune");
        //公司
        docInfo.setCompany("www.Tsune.com");
        //4、获取文档摘要信息
        SummaryInformation summInfo = workbook.getSummaryInformation();
        summInfo.setTitle("员工信息表");
        summInfo.setAuthor("Tsune");
        summInfo.setComments("本文档由Tsune提供");
        //5、设置标题栏颜色
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            cell16.setCellValue(emp.getBegindate());
            HSSFCell cell17 = row.createCell(17);
            cell17.setCellStyle(dateCellStyle);
            cell17.setCellValue(emp.getConversiontime());
            HSSFCell cell18 = row.createCell(18);
            cell18.setCellStyle(dateCellStyle);
            cell18.setCellValue(emp.getBegincontract());
            HSSFCell cell19 = row.createCell(19);
            cell19.setCellStyle(dateCellStyle);
            cell19.setCellValue(emp.getEndcontract());
            row.createCell(20).setCellValue(emp.getContractterm());
            row.createCell(21).setCellValue(emp.getTiptopdegree());
            row.createCell(22).setCellValue(emp.getSpecialty());
